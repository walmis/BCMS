...
#define CLKSRCSEL_CLKSRC 0, 2



//MSEL: PLL Multiplier Selection
#define PLL1CFG_MSEL 0, 5
//PSEL: PLL Divider Selection
#define PLL1CFG_PSEL1 6, 2

//CCLKSEL: Divide Value for CPU Clock from PLL0
#define CCLKCFG_CCLKSEL 0, 8
/*
...
#define PCLK0_WDT 0, 2
#define PCLK0_TIMER0 2, 2 
#define PCLK0_TIMER1 4, 2
#define PCLK0_UART0 6, 2
#define PCLK0_UART1 8, 2
#define PCLK0_PWM1 12, 2
#define PCLK0_I2C0 14, 2
#define PCLK0_SPI 16, 2
#define PCLK0_SSP1 20, 2
#define PCLK0_DAC 22, 2
#define PCLK0_ADC 24, 2
#define PCLK0_CAN1 26, 2
#define PCLK0_CAN2 28, 2
#define PCLK0_ACF 30, 2



#define PCLK1_QEI 0, 2
#define PCLK1_GPIO 2, 2
#define PCLK1_PCB 4, 2
#define PCLK1_I2C1 6, 2
#define PCLK1_SSP0 10, 2
#define PCLK1_TIMER2 12, 2
#define PCLK1_TIMER3 14, 2
#define PCLK1_UART2 16, 2
#define PCLK1_UART3 18, 2
#define PCLK1_I2C2 20, 2
#define PCLK1_I2S 22, 2
#define PCLK1_RIT 26, 2
#define PCLK1_SYSCON 28 , 2
#define PCLK1_MC 30, 2
...
#define CLKSRCSEL_Val         0x00000001   // select main oscillator as PLL0 clock source

#define PLL0_SETUP            1
//#define PLL0CFG_Val           0x00050063

#define PLL0CFG_Val (_S(PLL0CFG_MSEL, (M-1)) | _S(PLL0CFG_NSEL, (N-1)))
...
#define CCLKCFG_Val           (CLKDIV-1)
#define USBCLKCFG_Val         0x00000005


#define PCLKSEL0_Val          0
#define PCLKSEL1_Val          _S(PCLK1_GPIO, PCLK_DIV1)

#define PCONP_Val             ((1 << 15))            // Powered on: uart0, gpio, timer3, USB
